...
export const MutationStore = {
  ...
  mutation addMarker ($markerName: String!, $location: GeoJsonPointInput!, $creationDate: DateTime!) {
    addMarker(marker_name: $markerName, location: $location, creation_date: $creationDate) {
      id
      marker_name
      description
      creation_date
